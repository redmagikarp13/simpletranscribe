...
gh release create v1.0.9 SimpleTranscribe-Mac.zip --title "Simple Transcribe v1.0.9 (Native Mac App)" --notes "Release Inicial da versão nativa para macOS (Apple Silicon)"

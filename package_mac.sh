...
gh release create v1.0.8 SimpleTranscribe-Mac.zip --title "Simple Transcribe v1.0.8 (Native Mac App)" --notes "Release Inicial da versão nativa para macOS (Apple Silicon)"
